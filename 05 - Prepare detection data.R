...
(e.count.02 <- (((2 + lens.rad) / pi) * (3.5 / 1000) * 28 * (0.072 * (86400 / 1000)) * (0.2 * 100)))
(e.count.05 <- (((2 + lens.rad) / pi) * (3.5 / 1000) * 28 * (0.072 * (86400 / 1000)) * (0.5 * 100)))
(e.count.10 <- (((2 + lens.rad) / pi) * (3.5 / 1000) * 28 * (0.072 * (86400 / 1000)) * (1.0 * 100)))
(e.count.25 <- (((2 + lens.rad) / pi) * (3.5 / 1000) * 28 * (0.072 * (86400 / 1000)) * (2.5 * 100)))
(e.count.50 <- (((2 + lens.rad) / pi) * (3.5 / 1000) * 28 * (0.072 * (86400 / 1000)) * (5.0 * 100)))

# keep everything in m / s 
(e.count.02 <- (((2 + lens.rad) / pi) * 3.5 * (28 * 24 * 60 * 60) * 0.072 * (0.2 / 10000)))
(e.count.05 <- (((2 + lens.rad) / pi) * 3.5 * (28 * 24 * 60 * 60) * 0.072 * (0.5 / 10000)))
(e.count.10 <- (((2 + lens.rad) / pi) * 3.5 * (28 * 24 * 60 * 60) * 0.072 * (1.0 / 10000)))
(e.count.25 <- (((2 + lens.rad) / pi) * 3.5 * (28 * 24 * 60 * 60) * 0.072 * (2.5 / 10000)))
(e.count.50 <- (((2 + lens.rad) / pi) * 3.5 * (28 * 24 * 60 * 60) * 0.072 * (5.0 / 10000)))
