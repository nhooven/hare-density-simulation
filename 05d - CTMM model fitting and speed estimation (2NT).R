...
# Script: 05d - CTMM model fitting and speed estimation (2NT)
...
# "GPS" tracks
all.tracks <- read.csv("Derived data/Sampled - GPS tracks/tracks_2NT.csv")
...
write.csv(ctmm.speeds, file = paste0(getwd(), "/Derived data/Sampled - CTMM speeds/ctmm_speeds_2NT.csv"))
