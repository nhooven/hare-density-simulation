...
landscape.covs <- rast("Rasters/complex.tif")
...
write.csv(sims.df, paste0(getwd(), "/Derived_data/Simulated data/sims_complex_high.csv"))

write.csv(coefs.df, paste0(getwd(), "/Derived_data/Simulated data/coefs_complex_high.csv"))
