...
# Script: 03c - Movement simulations (complex - low)
...
write.csv(sims.df, paste0(getwd(), "/Derived_data/Simulated data/sims_C3L.csv"))
write.csv(all.coef.draws, paste0(getwd(), "/Derived_data/Simulated data/coefs_C3L.csv"))
